...
export default function Equipment() {
  ...
  const [isDaytimeOpen, setIsDaytimeOpen] = useState(false);
  ...
  return (
    <>
      <Header />
      <main
        className={`my-2 px-mobileXPadding text-blueBlack dark:text-almostWhite`}
      >
        <h2 className={`text-2xl font-semibold`}>EQUIPMENT</h2>
        <p className={`mb-4`}>
          Below is by photography equipment that I currently use or have used to
          capture my images.
        </p>
